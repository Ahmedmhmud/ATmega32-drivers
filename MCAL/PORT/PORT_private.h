...
#define PORTA_Register  *((v_u_8*) 0x3B)
#define PORTB_Register  *((v_u_8*) 0x38)
#define PORTC_Register  *((v_u_8*) 0x35)
#define PORTD_Register  *((v_u_8*) 0x32)

#define DDRA_Register   *((v_u_8*) 0x3A)
#define DDRB_Register   *((v_u_8*) 0x37)
#define DDRC_Register   *((v_u_8*) 0x34)
#define DDRD_Register   *((v_u_8*) 0x31)
